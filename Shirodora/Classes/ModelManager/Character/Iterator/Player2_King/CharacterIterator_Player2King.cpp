//
//  CharacterIterator_Player2King.cpp
//  Shirodora
//
 ...
 *  @desc   コンストラクタ
 */
CCharacterIterator_Player2King::CCharacterIterator_Player2King(IAggregateTemplate<CCharacter*> *pAggre) :
CIteratorTemplate<CCharacter *>(pAggre){}

/**
 *  @desc   デストラクタ
 */
CCharacterIterator_Player2King::~CCharacterIterator_Player2King(){}
 ...
 */
bool CCharacterIterator_Player2King::hasNext(){
    // 最大数を超えていたらfalse
